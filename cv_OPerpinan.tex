...
\label{sec-4-1}
\begin{center}
\begin{tabular}{p{18mm}p{10mm}p{40mm}p{40mm}p{10mm}p{15mm}r{10mm}}
...
\label{sec-5-3-1}
\begin{itemize}
\item “Une estimation de puissance dans un système photovoltaique avec Random Forest”, Kobaa Abdeslam (Université Montpellier 2).
...
\label{sec-5-3-2}
17 Proyectos de Fin de Máster desde el curso 2001/2002 hasta la actualidad, destacando:
\begin{itemize}
...
\section{Artículos en Revistas y Capítulos en Libros}
\label{sec-7}
...
\begin{itemize}
\item M. Pinho Almeida, \textbf{O. Perpiñán}, L. Narvarte, \guillemotleft{}PV Power Forecast Using a Nonparametric PV Model Solar Energy\guillemotright{} Solar Energy, 2015. Aceptado para publicación. (Índice de impacto: 3.868, Tercil T1 en categoría \emph{Energy \& Fuels})
...
\item Tipo de convocatoria: UE
\item Entidades Participantes: Isofoton, Ayto. Helmond, Ayto. Leganes, Fraunhofer Ise, Biohaus
...
\item Aportación del Investigador:
\begin{itemize}
\item Diseño de sistemas fotovoltaicos con modulos fotovoltaicos con sistema externo de concentracion 2x.
\end{itemize}
\end{itemize}
...
\end{itemize}
\end{itemize}
\subsection{Mejora de la Calidad del Servicio Energetico en las Aplicaciones de Electrificacion Rural}
\label{sec-8-8}
\begin{itemize}
\item Entidad Financiadora: Ministerio de Educación y Ciencia
...
\begin{itemize}
\item Entidad Financiadora: Ministerio de Educacion y Ciencia
...
\subsection{Caracterización del Comportamiento Térmico de la Fachada PVSKIN y su Interaccion con Edificios Modelo en Clima Mediterráneo}
\label{sec-8-11}
...
\subsection{Desarrollo y Caracterizacion de Tejados y Fachadas Fotovoltaicas Ventiladas Integradas en Edificios}
\label{sec-8-12}
...
\item Investigador Principal: Pablo Gutierrez Martin (LACECAL)
\item Nº Investigadores: 13
\item Responsabilidad: Investigador colaborador
\item Aportación del Investigador:
\begin{itemize}
\item Diseño y ejecucion de sistemas fotovoltaicos de conexion a red
\item Diseño de sistemas fotovoltaicos para probar los equipos diseñados
\item Coordinación de la participacion de Isofoton en este proyecto
\end{itemize}
\end{itemize}

\subsection{Conector de Paneles Dinamico CPD-1 y Convertidor Multipuente Multipotencia CMM-1}
\label{sec-8-14}
...
\item Duración: desde 01/07/2007 hasta 30/06/2008 N° total de meses: 12
\item Investigador Principal: Jose Antonio Dominguez Vazquez (LACECAL)
...
\subsection{Optimización del Diseño Electrico de Modulos Fotovoltaicos para Minimizar las Perdidas de Potencia por Dispersion y Evitar los Puntos Calientes}
\label{sec-8-15}
...
\subsection{Desarrollo de una Plataforma para la Monitorizacion y Seguimiento de Sistemas Fotovoltaicos}
\label{sec-8-16}

\begin{itemize}
\item Entidad Financiadora: Corporacion Tecnologica de Andalucia
\item Cantidad Financiada (€): 400034
\item Referencia del Proyecto: 06109D1A
\item Tipo de convocatoria: CC.AA.
\item Entidades Participantes: Isofotón, ISM, Universidad de Malaga
...
\subsection{Sistema de Desalinizacion mediante Osmosis Inversa Alimentado con Energía Solar Fotovoltaica}
\label{sec-8-17}
...
\subsection{IX Congreso Internacional de Ingenieria de Proyectos}
\label{sec-9-7}
...
\subsection{VII Congreso Internacional de Ingeniería de Proyectos}
\label{sec-9-11}
...
\subsection{VI Congreso Internacional de Ingenieria de Proyectos}
\label{sec-9-14}
...
\item[{Producto BOS}] desarrollo de equipos electrónicos para diferentes aplicaciones, supervision de los equipos disponibles en el mercado
