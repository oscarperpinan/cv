...
\label{sec:org29f55f8}
\subsection{Generales}
\label{sec:org20d5930}
...
\label{sec:orgf723442}
\subsection{Doctor}
\label{sec:org376ff98}
\begin{itemize}
...
\label{sec:orgc2f430d}

Colaborador en el Máster de Energías Renovables y Mercado Energético (MERME) de la Escuela de Organización Industrial:

\begin{itemize}
\item Cursos 2017-2018 a 2009-2010: Asignatura troncal ``Energía Solar Fotovoltaica'' con un total de 70 horas lectivas.
...
\label{sec:orgd8f079b}
\subsubsection{ETSIDI}
\label{sec:orgd0dcdc5}
\begin{itemize}
...
\label{sec:org76bbbbd}
O. Perpiñán, 2015. Libro autoeditado, publicado online con licencia Creative Commons.  \url{http://oscarperpinan.github.com/esf}

\subsection{Diseño de Sistemas Fotovoltaicos}
\label{sec:org5bb4240}
...
\label{sec:org95f61f9}
\subsection{Publicaciones Internacionales}
\label{sec:orgedd74c7}
...
\section{Desarrollos}
\label{sec:org1ecc8f5}
\subsection{solaR}
\label{sec:orgf2db5ee}
...
\item Curso \guillemotleft{}R avanzado\guillemotright{} (8 horas) para profesores de la UPM (Instituto de Ciencias de la Educación, UPM): Julio 2017, Febrero 2016.
...
\label{sec:org07b4399}
\subsection{Acreditaciones}
\label{sec:org71b79d9}
