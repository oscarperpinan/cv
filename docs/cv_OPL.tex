...
\label{sec:org68c95af}
\subsection{Generales}
\label{sec:org35fef4d}
...
\label{sec:org632626a}
\subsection{Doctor}
\label{sec:org93e81b7}
\begin{itemize}
...
\label{sec:orgbbe0b87}
\subsection{Dirección de Tesis Doctorales}
\label{sec:org651c18a}
...
\label{sec:orgce1d735}
\subsubsection{ETSIDI}
\label{sec:orgfff3a21}
\begin{itemize}
...
\label{sec:org318e4b1}
\subsection{Publicaciones Internacionales}
\label{sec:orgbe9bb7b}
...
\label{sec:orgc3a0209}
\subsection{21th EGU General Assembly, EGU2019}
\label{sec:orgf88eb1b}
Congreso Internacional celebrado en 2019, Austria.

Impact of aerosols on PV power projections over Europe: Gutiérrez, Claudia; Somot, Samuel; Nabat, Pierre; Mallet, Marc; Ángel Gaertner, Miguel; \textbf{Perpiñán, Oscar}

\subsection{20th EGU General Assembly, EGU2018,}
\label{sec:org7c32273}
...
\section{Desarrollos}
\label{sec:orgbf185a0}
\subsection{solaR}
\label{sec:orgdc553ae}
...
\label{sec:orgd368329}
\subsection{Acreditaciones}
\label{sec:org9badc74}
